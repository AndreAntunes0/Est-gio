...
$sql = "SELECT * FROM filhoses WHERE Nome = '$id' ";
...
<html>
    ...
    <!--[if lt IE 9]>
      ...
      <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script><![endif]-->
        ...
        <link rel="stylesheet" href="css/lista/templatemo-main2.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="left-text">
                        <p>Produtos: <a class="padd4"></a> <?php echo $jogo["Produtos"]; ?> </p><br>
                    </div>
                    <div class="left-text">
                        <p>Data de Entrega: <a class="padd5"></a> <?php echo $jogo["Data"]; ?> </p><br>
                    </div>
                </div>
